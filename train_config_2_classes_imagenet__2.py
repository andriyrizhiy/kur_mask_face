...
config.TRAIN.lr_value_every_step = [0.0001,0.0001,0.0001,0.0001,0.0001,0.0001]        ##warm up is used
...
config.MODEL = edict()
config.MODEL.continue_train=False ### revover from a trained model
config.MODEL.model_path = './mobilenetv2_base_2_classes_imagenet_fix__2/'  # save directory
