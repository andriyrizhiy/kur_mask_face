...
config.TRAIN.train_set_size=3533              ###widerface train size
config.TRAIN.val_set_size=507                 ###widerface val size
...
config.DATA.train_txt_path='only_without_mask_dataset_without_wider/train.txt'
config.DATA.val_txt_path='only_without_mask_dataset_without_wider/val.txt'
...
config.MODEL = edict()
config.MODEL.continue_train=False ### revover from a trained model
config.MODEL.model_path = './mobilenetv2_base_only_without_masks_fix_without_wider/'  # save directory
