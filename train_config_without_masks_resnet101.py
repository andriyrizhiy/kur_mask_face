...
config.MODEL = edict()
config.MODEL.continue_train=False ### revover from a trained model
config.MODEL.model_path = './resnet101_base_only_without_masks_fix/'  # save directory
config.MODEL.net_structure='resnet_v1_101' ######'resnet_v1_50,resnet_v1_101,MobilenetV2
