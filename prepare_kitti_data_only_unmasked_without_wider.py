...
images_train = sorted(glob.glob('/data/nks/k/MaskedFace/data//kitti_out_without_wider/train/images/*'))
labels_train = sorted(glob.glob('/data/nks/k/MaskedFace/data//kitti_out_without_wider/train/labels/*'))
images_val = sorted(glob.glob('/data/nks/k/MaskedFace/data//kitti_out_without_wider/test/images/*'))
labels_val = sorted(glob.glob('/data/nks/k/MaskedFace/data//kitti_out_without_wider/test/labels/*'))
...
def kitti_data_file():
    ...
    fw = open('only_without_mask_dataset_without_wider/train.txt', 'w')
    ...
    fw = open('only_without_mask_dataset_without_wider/val.txt', 'w')
    for index in range(len(img_paths)):
