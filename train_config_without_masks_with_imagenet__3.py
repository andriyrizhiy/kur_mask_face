...
config.TRAIN.lr_value_every_step = [0.0001,0.00001,0.000001]        ##warm up is used
config.TRAIN.lr_decay_every_step = [8000,9000]
...
config.MODEL = edict()
config.MODEL.continue_train=False ### revover from a trained model
config.MODEL.model_path = './mobilenetv2_base_only_without_masks_imagenet_fix__3/'  # save directory
