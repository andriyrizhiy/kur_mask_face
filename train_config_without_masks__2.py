...
config.TRAIN.lr_value_every_step = [0.001, 0.001]        ##warm up is used
config.TRAIN.lr_decay_every_step = [10000]
...
config.MODEL = edict()
config.MODEL.continue_train=False ### revover from a trained model
config.MODEL.model_path = './mobilenetv2_base_only_without_masks_fix___2/'  # save directory
