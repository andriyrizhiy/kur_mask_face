...
from lib.core.model.net.mobilenet.mobilenet_v2 import mobilenet_v2_050, mobilenet_v2_140
...
def mobilenet_ssd(image,L2_reg,is_training=True):
    ...
    with tf.contrib.slim.arg_scope(arg_scope):
        ...
        _,endpoint = mobilenet_v2_140(image,is_training=is_training,base_only=True,finegrain_classification_mode=False)
