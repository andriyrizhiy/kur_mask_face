...
class DSFD():
    ...
    def forward(self,inputs,boxes,labels,l2_regulation,training_flag,with_loss=True):
        ...
        # {'boxes': boxes, 'scores': scores, 'num_boxes': num_detections}
        result_network = self.postprocess(final_reg, final_cls, anchors_)



        return reg_loss,cls_loss, result_network
    ...
    def postprocess(self,box_encodings,cla,anchors, \
        ...
        return {'boxes': boxes, 'scores': scores, 'num_boxes': num_detections, 'labels':labels}
