...
ap.add_argument( "--data_dir", required=False, default="/data/raw_dataset/fddb/images", help="dir to img")
ap.add_argument( "--split_dir", required=False,default='/data/raw_dataset/fddb/FDDB-folds',help="dir to FDDB-folds")
