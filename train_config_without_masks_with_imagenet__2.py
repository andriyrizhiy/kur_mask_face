...
config.TRAIN.train_set_size=7321
config.TRAIN.val_set_size=1149
...
config.DATA.train_txt_path='only_without_mask_dataset/train.txt'
config.DATA.val_txt_path='only_without_mask_dataset/val.txt'
...
config.MODEL.model_path = './mobilenetv2_base_only_without_masks_imagenet_fix__2/'  # save directory
